...
import com.example.juli_soep.sekolah.helper.admin_keuangan.AdapterGajih;
import com.example.juli_soep.sekolah.helper.admin_keuangan.DataGajih;
...
public class ListDataGajih extends AppCompatActivity {

    private Toolbar mTopToolbar;
    AdapterGajih adapter;
    ListView list;
    //SwipeRefreshLayout swipe;
    ArrayList<DataGajih> newsList = new ArrayList<DataGajih>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_data_gajih);
        ...
        adapter = new AdapterGajih(ListDataGajih.this, newsList);
        ...
        /*list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListDataGajih.this, DetailPeminjaman.class);
                intent.putExtra("nik", newsList.get(position).getNik());
                intent.putExtra("nama", newsList.get(position).getNama());
                intent.putExtra("pinjaman", newsList.get(position).getGjihBesih());
    ...
    public void onBackPressed() {
        Intent a = new Intent(ListDataGajih.this, AppsKeuangan.class);
        startActivity(a);
        finish();
    }
    ...
    private void getData() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Config.URL, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if(error == false){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            DataGajih news = new DataGajih();

                            news.setNik(jsonObject.getString("nik"));
                            news.setNama(jsonObject.getString("nama"));
                            news.setGjihBesih(jsonObject.getString("gaji_bersih"));
                            news.setTgl(jsonObject.getString("tgl_input"));
            ...
            public void onErrorResponse(VolleyError error){
                ...
                hideDialog();
                Intent i = new Intent(ListDataGajih.this,AppsKeuangan.class);
                startActivity(i);
                finish();
            }
        }){
            ...
            protected Map<String, String> getParams(){
                ...
                params.put("tag","viewAllDataGaji");
                return params;
            }
        };
